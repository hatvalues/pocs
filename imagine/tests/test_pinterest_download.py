...
def test_extract_board_name(pinterest_downloader):
    with pytest.raises(TypeError):
        pinterest_downloader.extract_board_name(None)

    assert pinterest_downloader.extract_board_name("dummy") == "dummy"
    assert pinterest_downloader.extract_board_name("https://de.pinterest.com/julianhatwell/discrae/by-me/") == "julianhatwell_discrae_byme"

def test_extract_file_name(pinterest_downloader):
    with pytest.raises(ValueError):
        pinterest_downloader.extract_file_name(None)

    with pytest.raises(ValueError):
        pinterest_downloader.extract_file_name("dummy")
    assert pinterest_downloader.extract_file_name("https://de.pinterest.com/pin/397513104614841320/") == "397513104614841320"
    assert pinterest_downloader.extract_file_name("https://i.pinimg.com/1200x/88/3c/ab/883cab882a4b67bc2aa05555c5ece333.jpg") == "883cab882a4b67bc2aa05555c5ece333.jpg"
